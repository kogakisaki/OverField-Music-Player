...
> [!NOTE] 
> **⚠️ ゲームバージョンに関する注意** > **楽器家具**演奏機能は現在、「OverField」(开放空间) の**中国サーバーでのみ利用可能**です。
...
> [!TIP] 
> **気に入りましたか？** 開発をサポートするために、GitHub で ⭐ **Star** をつけていただけると嬉しいです！
...
> [!TIP] 
> **MIDI ファイルをお探しですか？** [OnlineSequencer.net](https://onlinesequencer.net/sequences) で高品質な MIDI シーケンスを見つけることができます。
